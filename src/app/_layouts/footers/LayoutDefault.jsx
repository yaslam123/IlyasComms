            ...
            <div className="col-lg-8">
              <div className="row">
                ...
                <div className="col-md-6 col-lg-6 col-xl-3 mil-up mil-mb-90">
                  ...
                  <p className="mil-text-md mil-up mil-light-costume mil-mb-10">
                    <a href="/team" className="mil-light-costume-child">
                      Team
                    </a>
                  </p>
                  <p className="mil-text-md mil-up mil-light-costume mil-mb-10">
                ...
                <div className="col-md-6 col-lg-6 col-xl-3">
                  ...
                  <p className="mil-text-md mil-up mil-light-costume mil-mb-10">
                    <a
                      href="https://twitter.com/IlaysComms"
                      className="mil-light-costume-child"
                    >
                      Twitter
                    </a>
                  ...
                  <p className="mil-text-md mil-up mil-light-costume mil-mb-10">
                    <a
                      href="https://www.instagram.com/ilayscomms?igshid=MzRlODBiNWFlZA"
                      className="mil-light-costume-child"
                    >
                      Instagram
                    </a>
                ...
                <div className="col-md-6 col-lg-6 col-xl-3">
                  ...
                  <p className="mil-text-md mil-up mil-light-costume mil-mb-30">
