  ...
  return (
    <>
      <PageBanner
        ...
        bgImage={"/img/Personal/About us.png"}
      />
                ...
                <>
                  {postData.description.map((item, key) => (
                    <React.Fragment key={`service-description-${key}`}>
                      {item.layout == 1 && (
                        <>
                          <h2 className="mil-upper mil-up mil-mb-60">
                            {item.title}
                          </h2>
                          <div
                            ...
                            <div className="col-lg-5">
                              <ul className="mil-icon-list mil-mb-60">
                                {item.list.map((list_item, list_key) => (
                                  <li
                                    className="mil-up"
                                    key={`service-description-${key}-list-${list_key}`}
                                  >
                      ...
                      <>
                        ...
                        <ul className="mil-list mil-dark mil-up mil-mb-30">
                          {item.content.map((list_item, list_key) => (
                            <li
                              key={`service-sidebar-${key}-values-${list_key}`}
                            >
                              {list_item}
                            </li>
                          ))}
          ...
          {/* <div className="row">
            <div className="col-12">
              <div className="mil-center mil-mb-90">
                ...
                <h2 className="mil-upper mil-up">hello</h2>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="mil-card-number"></div>
              <div className="mil-center">
                <div className="mil-icon mil-icon-lg mil-mb-30">
                  <img src="/img/icons/5.svg" alt="" />
                </div>
                <h5 className="mil-upper mil-mb-20">Event Planing</h5>
                <div className="mil-divider-sm mil-mb-20" />
                <ul className="mil-service-text">
                  <ol>helo</ol>
                  <ol>helo</ol>
                  <ol>helo</ol>
                </ul>
          ...
          <div className="row justify-content-between">
            <div className="col-lg-7">
                            ...
                            <div className="col-lg-5">
                              <ul className="mil-icon-list mil-mb-60">
                                {item.list.map((list_item, list_key) => (
                                  <li
                                    className="mil-up"
                                    key={`service-description2-${key}-list-${list_key}`}
                                  >
                                    <img src="/img/icons/11.svg" alt="icon" />
                                    {list_item}
                                  </li>
              ...
              {postData.faq != undefined && (
                <>
                  <span className="mil-suptitle mil-upper mil-dark mil-up mil-mb-30">
                    {postData.faq.subtitle}
                  </span>
                  <h2 className="mil-upper mil-up mil-mb-60">
                    {postData.faq.title}
                  </h2>
                  ...
                  <React.Fragment key={`sidebar2-item-${key}`}>
                    {item.layout == "list" && (
                      <>
                        ...
                        <ul className="mil-list mil-dark mil-up mil-mb-30">
                          {item.content.map((list_item, list_key) => (
                            <li key={`sidebar2-item-${key}-values-${list_key}`}>
                              {list_item}
                            </li>
                          ))}
                        </ul>
                      ...
                      <>
                        <div className="row">
                          {item.content.map((list_item, list_key) => (
                            <div
                              className="col-6"
                              key={`sidebar2-item-${key}-values-${list_key}`}
                            >
                              <div className="mil-counter-frame mil-up mil-mb-30">
                                <h5 className="mil-mb-5">
                                  <span
